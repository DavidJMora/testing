...
//     // return str.match(regExp).length /**This version counts how many matches there are  */
//     return str.length - str.replace(regExp, "").length /**This version takes initial length and subtracts it from the new string after replacing value with nothing. */
// }


// console.assert(solution("The raid is Spain", "a") === 2, `Error`);
// console.assert(solution("Mississippi", "i") === 4, `Error`);
// console.assert(solution("Hacking with JavaScript", "i") === 3, `Error`);
...
// console.assert(solution("a   b   c") === "a b c", `Error`);
// console.assert(solution("    a") === " a", `Error`);
// console.assert(solution("abc") === "abc", `Error`);

// function solution(arr, num) {

//     let regExp = new RegExp(num, "g");
    
//     let matches = arr.join("").match(regExp);
    
//     return matches === null ? 0 : matches.length
// }

// console.assert(solution([5, 15, 55, "515"], "5") === 6, `Error`);
// console.assert(solution([5, 15, 55, 515], "1") === 2, `Error`);
// console.assert(solution([55555], "5") === 5, `Error`);
// console.assert(solution([55555], "1") === 0, `Error`);
...
function solution(str) {
    ...
    // console.log(matches.reduce((acc, item) => acc += Number(item), 0));
    ...
    // }
    // return sum
    return str.match(regExp).reduce((acc, item) => acc += Number(item), 0)
}

console.assert(solution("a1b2c3") === 6, `Error`);
console.assert(solution("a10b20c30") === 60, `Error`);
console.assert(solution("sdfas8asd8fa") === 16, `Error`);